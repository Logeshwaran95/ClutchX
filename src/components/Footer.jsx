...
export default function Footer() {
  ...
  return (
    <footer className="w-full mt-16">
      {/* Glassmorphism container — full width with side margins */}
...
>
  ...
  <p className="mt-2 text-gray-200 text-sm leading-relaxed">
    ClutchX is your ultimate platform for modern solutions and seamless experiences. 
    Our mission is to deliver top-notch services with innovative design and cutting-edge technology.
  </p>
</motion.div>
          {/* Middle: Useful Links — perfectly centered */}
          <motion.div
