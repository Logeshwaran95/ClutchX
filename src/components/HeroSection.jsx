...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-screen flex items-center mt-24 sm:mt-28 lg:mt-8">
  ...
  />
        ...
        >
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-[380px] lg:h-[380px] rounded-2xl overflow-hidden backdrop-blur-md border border-white/20 shadow-lg hover:scale-105 transition duration-300 ease-in-out">
            <img
